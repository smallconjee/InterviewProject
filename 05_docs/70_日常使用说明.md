...
```bash
# ① 读考题：只看需求，不看参考
open 05_docs/80_一档闭卷重写规格.md     # 对应模块小节
...
| 文件 | 用途 | 什么时候看 |
|---|---|---|
| `05_docs/70_日常使用说明.md` | 本文件：日常操作 | 遇到操作问题 |
| `05_docs/80_一档闭卷重写规格.md` | 一档闭卷考卷（7 模块需求+验收） | 每次重写前 |
| `05_docs/30_面试弹药库.md` | 弹药库：12 模块讲解+追问卡+踩坑 | diff 后对答案、面试前复习 |
| `05_docs/10_架构总览.md` | 链路全景图 + 实现状态 | 讲架构叙事时 |
