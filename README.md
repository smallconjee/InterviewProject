...
- `05_docs/00_阅读地图.md` — **从这开始**：全部文档的阅读顺序和定位
- `05_docs/10_架构总览.md` — 架构总览（链路图 + 当前实现状态）
- `05_docs/30_面试弹药库.md` — 面试弹药库（13 模块：设计讲解 + 追问卡 + 踩坑实录）
- `05_docs/20_面试题库.md` — 面试官问题全景库（题库，约 250 题 + 高危 Top15）
- `05_docs/答案库/` — 答案库（16 文件口语稿，与题库配套；含自我介绍双版本）
- `05_docs/面试工具包/` — 面试工具包（统一口径与生产数字 / 手撕参考集 / 简历快照 / 明早校对清单）
- `05_docs/简历/` — 简历修订稿 + 文本层验收指南 + 仿样式重建 PDF
- `05_docs/70_日常使用说明.md` — **使用说明**（日常启停/命令速查/重写工作流/故障排查）
- `05_docs/80_一档闭卷重写规格.md` — 一档模块闭卷重写需求文档（学习路径）
